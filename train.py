...
if __name__ == '__main__':
    ...
    opt  = {
        'use_cuda':True,
        'class_path':'config/retail-product-checkout.names',
        'data_config_path':'config/retail-product-checkout.data',
        'model_config_path':'config/yolov3.cfg',
        'batch_size':parsed_arguments.batch_size,
        'n_cpu':parsed_arguments.n_cpu,
    ...
    dataloader = getDataLoader(opt, data_config['train'], True)
